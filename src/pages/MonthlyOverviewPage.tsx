...
export function MonthlyOverviewPage() {
  ...
  const monthName = todayDate.toLocaleDateString('en-IN', {
    month: 'long',
    year: 'numeric',
  });
    ...
    <div className="flex flex-col min-h-screen pb-20 px-4 pt-6">
      ...
      <div className="bg-gray-100 rounded-lg p-4 mb-4">
        ...
        <div className="flex justify-between mt-1">
          {dailySpending.map((day) => (
            <span key={day.date} className="flex-1 text-xs text-gray-500 text-center">
              {day.label}
            </span>
          ))}
        </div>
